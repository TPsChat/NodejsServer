...
const initiateGroupCall = async (req, res) => {
    try {
        ...
        console.log(`[GroupCall] Call created successfully by caller. callId=${call.callId}`);
        ...
        console.log(`[GroupCall] Call lookup result for chatId ${chatId}: callId=${call.callId}, wasJustCreated=${wasJustCreated}, participants=${call.participants.length}`);
        ...
        console.log(`[GroupCall] Returning call for chatId ${chatId}: callId=${call.callId}, participants=${call.participants.length}`);
